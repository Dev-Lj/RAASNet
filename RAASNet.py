...
''' % (time.strftime('%d/%m/%Y'),
 ...
 # I do not want to login, therefore we skip this part and redirect to the main window
main = MainWindow("Hackerman", "MyPw", "Hackerman@mail.com", "Hacker", "Man", "VIP", "Hacking")
main.mainloop()
